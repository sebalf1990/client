...
Private Sub loadButtons()
    ...
    Call cBotonComprar.Initialize(cmdComprar, "boton-comprar-default.bmp", "boton-comprar-over.bmp", "boton-comprar-off.bmp", Me)
    Call cBotonVender.Initialize(cmdVender, "boton-vender-default.bmp", "boton-vender-over.bmp", "boton-vender-off.bmp", Me)
