...
Private Sub AuthSocket_Error(ByVal Number As Integer, _
    ...
    Private Sub render_MouseUp(Button As Integer, Shift As Integer, x As Single, y As Single)
        ...
        Select Case g_game_state.State()
            ...
            Case e_state_account_screen
                ...
                End If
                If (x > 970 And x < 1020) And (y > 675 And y < 708) Then
                    character_screen_action = e_action_transfer_character
                End If
                If (x > 930 And x < 965) And (y > 675 And y < 708) Then
                ...
                Select Case character_screen_action
                    ...
                    Case e_action_delete_character
                        ...
                        If MsgBox(JsonLanguage.Item("MENSAJEBOX_BORRAR_PERSONAJE") & DeleteUser & JsonLanguage.Item("MENSAJEBOX_DE_LA_CUENTA"), vbYesNo + vbQuestion, _
                                JsonLanguage.Item("MENSAJEBOX_BORRAR_TITULO")) = vbYes Then
