...
Private Function validipv4str(ByVal IP As String) As Boolean
    ...
    If Not ValidNumber(tmpArr(0), eNumber_Types.ent_Byte) Or Not ValidNumber(tmpArr(1), eNumber_Types.ent_Byte) Or Not ValidNumber(tmpArr(2), eNumber_Types.ent_Byte) Or Not _
            ValidNumber(tmpArr(3), eNumber_Types.ent_Byte) Then Exit Function
    validipv4str = True
    Exit Function
validipv4str_Err:
