...
Private Sub loadButtons()
    ...
    Call cBotonCerrar.Initialize(salir, "boton-cerrar-default.bmp", "boton-cerrar-over.bmp", "boton-cerrar-off.bmp", Me)
    Call cBotonMas.Initialize(cmdMasMenos(0), "boton-sm-mas-default.bmp", "boton-sm-mas-over.bmp", "boton-sm-mas-off.bmp", Me)
    Call cBotonMenos.Initialize(cmdMasMenos(1), "boton-sm-menos-default.bmp", "boton-sm-menos-over.bmp", "boton-sm-menos-off.bmp", Me)
    Call cBotonRetirar.Initialize(Image1(0), "boton-retirar-default.bmp", "boton-retirar-over.bmp", "boton-retirar-off.bmp", Me)
    Call cBotonDepositar.Initialize(Image1(1), "boton-depositar-default.bmp", "boton-depositar-over.bmp", "boton-depositar-off.bmp", Me)
End Sub
...
Private Sub interface_DblClick()
    ...
    Select Case ObjType
        Case eObjType.otArmadura, eObjType.otESCUDO, eObjType.otmagicos, eObjType.otFlechas, eObjType.otCASCO, eObjType.otAnillos
