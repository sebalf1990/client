...
Private Sub loadButtons()
    ...
    Call cBotonAbandonar.Initialize(cmdAbandonar, "boton-abandonar-default.bmp", "boton-abandonar-over.bmp", "boton-abandonar-off.bmp", Me)
    Call cBotonExpulsar.Initialize(cmdExpulsar, "boton-menos-default.bmp", "boton-menos-over.bmp", "boton-menos-off.bmp", Me)
    Call cBotonInvitar.Initialize(cmdInvitar, "boton-mas-default.bmp", "boton-mas-over.bmp", "boton-mas-off.bmp", Me)
End Sub
